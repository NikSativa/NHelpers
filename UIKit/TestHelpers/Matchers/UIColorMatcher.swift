...
//    let expectedText = [
//        "equals",
//        light ? nil : "light colors <\(actualValue.real(.light).friendlyDescription + "&" + expectedValue.real(.light).friendlyDescription)>",
//        dark ? nil : "dark colors <\(actualValue.real(.dark).friendlyDescription + "&" + expectedValue.real(.dark).friendlyDescription)>"
//    ]
