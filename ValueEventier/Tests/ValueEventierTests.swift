...
final class ValueEventierTests: XCTestCase {
    private let subject: ValueEventier<State> = .init(wrappedValue: .init(counter: -1, toggle: false))
...
// MARK: - ValueEventierTests.State

private extension ValueEventierTests {
